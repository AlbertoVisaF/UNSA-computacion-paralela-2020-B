...
int main(int argc, char* argv[]) {
   ...
   /* VÃ£o ser usadas apenas duas threads */
   thread_count = 2;
   
   //Inicializa a flag para falso, a fim de dizer ao consumidor que ele tem que esperar pelo produtor
   message_avaliable = 0;

   //A thread com my_rank igual a 0 Ã© a consumidora
   consumer = 0;

   thread_handles = malloc (thread_count*sizeof(pthread_t));

   //Inicializa o mutex para proteger a seÃ§Ã£o crÃ­tica de produÃ§Ã£o e consumo
